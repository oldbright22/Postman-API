...
newman run Jan28_ReviewInClass_RunCollection[RunTime]__ChainingRunning.postman_collection.json -e PROD.postman_environment.json -g workspace.postman_globals.json -r htmlextra
